...
class PromptForNewFileName(QDialog):
    def __init__(self, oldName, parent=None):
        super(PromptForNewFileName, self).__init__(parent)
        self.parent = parent
        self.oldName    = oldName
        self.label      = QLabel("Example input: data/design/layout/mynewlayout.layout\n"
                                 "Enter new file name:")
